...
let About=()=>{
    return(
      <div className="about">
        ...
        <h5 className='a'>You can contact through Instagram <i class="fa-brands fa-instagram"></i>   #dksra393,What'sapp <i class="fa-brands fa-whatsapp"></i> 8610593408,Gmail <i class="fa-solid fa-envelope"></i> dksra.com@gmail.com</h5>
      </div>
    )
  }
